    ...
    <SafeAreaView style={styles.root} edges={['top', 'left', 'right']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.9}
          onPress={() => navigation.navigate('DiscoverTab', { screen: 'CompanionProfileScreen', params: { id: data.companionId } })} accessibilityRole="button" accessibilityLabel={t('a11yGoToDiscovertab', 'Go to DiscoverTab')}
        >
