  ...
  const { t } = useTranslation(['onboarding']);
    ...
    <SafeAreaView style={styles.root} edges={['top', 'bottom']}>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7} accessibilityRole="button" accessibilityLabel="Go to BasicProfileSetup">
      ...
      <View style={styles.ctaBlock}>
        <TouchableOpacity
          ...
          activeOpacity={0.88} accessibilityRole="button" accessibilityLabel="Notifications">
