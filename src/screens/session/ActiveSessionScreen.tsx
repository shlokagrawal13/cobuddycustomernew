  ...
  return (
    <SafeAreaView style={styles.root} edges={['top', 'left', 'right']}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.sosBtn} onPress={() => (navigation as any).navigate('SafetySupportStack', { screen: 'SafetyHubScreen' })} accessibilityRole="button" accessibilityLabel={t('a11ySosEmergency', 'SOS / EMERGENCY')}>
      ...
      <Modal visible={extendModalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity style={styles.primaryBtn} onPress={handleConfirmExtension} accessibilityRole="button" accessibilityLabel={t('a11yAction', 'Action')}>
